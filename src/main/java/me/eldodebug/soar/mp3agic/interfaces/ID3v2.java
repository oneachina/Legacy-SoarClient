package me.eldodebug.soar.mp3agic.interfaces;

import java.util.ArrayList;
import java.util.Map;

import me.eldodebug.soar.mp3agic.ID3v2ChapterFrameData;
import me.eldodebug.soar.mp3agic.ID3v2ChapterTOCFrameData;
import me.eldodebug.soar.mp3agic.ID3v2FrameSet;
